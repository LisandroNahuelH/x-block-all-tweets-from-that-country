...
(function (global) {
  ...
  const EN_FALLBACK = {
    ...
    pop_opt_show_country_flags:
      'Show account country flag next to the username on feed, explore, and profiles',
    ...
    a11y_toggle_show_country_flags: 'Toggle country flags on the timeline',
